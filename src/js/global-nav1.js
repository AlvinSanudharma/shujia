window.addEventListener("scroll", function () {
    ...
    if (window.scrollY > 0) {
        ...
        back.classList.add("border", "border-shujia-gray-light");
        cart.classList.add("border", "border-shujia-gray-light");
        ...
        back.classList.remove("border", "border-shujia-gray-light");
